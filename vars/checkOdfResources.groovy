def call(){
    script {
        ...
        try {
            sh '''
               ssh -o 'StrictHostKeyChecking no' -i ${WORKSPACE}/deploy/id_rsa root@${BASTION_IP} "echo -e "$ oc get nodes" > /root/odf-resources.log ; oc get nodes >> /root/odf-resources.log"
