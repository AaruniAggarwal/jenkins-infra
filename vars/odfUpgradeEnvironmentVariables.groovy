    ...
    script {
        ...
        try {
            sh '''
               ...
               echo "export UPGRADE_OCS_VERSION=${UPGRADE_OCS_VERSION}" >> odf_vars.sh
               echo "export UPGRADE_OCS_REGISTRY=${UPGRADE_OCS_REGISTRY}" >> odf_vars.sh
            ...
            echo 'Error ! Exporting of environment variables for ODF Upgrade failed!'
